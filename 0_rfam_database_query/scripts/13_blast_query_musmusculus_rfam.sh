#!/bin/sh  -login
#PBS -l nodes=1:ppn=9,walltime=00:20:00,mem=3Gb
#PBS -N blastn_musmusculus_rfam_query
#PBS -j oe
#PBS -o /mnt/research/pigeqtl/analyses/microRNA/OutputsErrors/
#PBS -m a
#PBS -M perrykai@msu.edu

#' **Script:** `13_blast_query_musmusculus_rfam.sh`
#' 
...
#' 
#' **Input File(s):** `174_library_musmusculus_rfam_blast_input_uniq_seq.fa`
#' 
#' **Output File Directory:** `/mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/0_rfam_database_query/`
#' 
#' **Output File(s):** `4_musmusculus_rfam_blastn_output_e5.txt`
#' 
#' **Table of contents:**
#'
...
#' The databases used for this query were created from the Sus scrofa miRBase (release 21), the Sus scrofa ensembl (10.2) ncRNA database, and the Rfam database version 11.0.
...
#' 
#' BLASTing the small RNAseq unique sequences (expressed > 1 time) against the Sus scrofa miRBase, Sus scrofa Ensembl, and Rfam databases:
#' 
...
#' 
#' Tabular results:
blastn -query /mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/0_rfam_database_query/174_library_musmusculus_rfam_blast_input_uniq_seq.fa -task blastn-short -db /mnt/research/pigeqtl/analyses/microRNA/reference_sequences/"Musmusculus_Rfam_seq.fa" -out /mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/0_rfam_database_query/4_musmusculus_rfam_blastn_output_e5.txt -evalue 0.00001 -outfmt 6 -num_threads 8
