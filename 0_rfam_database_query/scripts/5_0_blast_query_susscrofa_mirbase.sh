...
#' **Script:** `5_0_blast_query_susscrofa_mirbase.sh`
#' 
...
#' 
#' BLASTing the small RNAseq unique sequences (~6.8 million sequences) against the Sus scrofa miRBase, Rfam, and Ensembl databases:
#' 
