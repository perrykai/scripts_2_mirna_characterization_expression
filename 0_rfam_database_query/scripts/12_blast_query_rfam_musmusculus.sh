...
#' **Script:** `12_blast_query_rfam_musmusculus.sh`
#' 
...
#' 
#' Tabular results:
blastn -query /mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/0_rfam_database_query/174_library_musmusculus_rfam_input_uniq_seq.fa -task blastn-short -db /mnt/research/pigeqtl/analyses/microRNA/reference_sequences/"Musmusculus_Rfam_seq.fa" -out /mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/0_rfam_database_query/4_musmusculus_rfam_blastn_output_e6.txt -evalue 0.000001 -outfmt 6 -num_threads 8
