...
#PBS -j oe
#PBS -o /mnt/research/pigeqtl/analyses/microRNA/OutputsErrors/miRNA_eQTL_targetscan
#PBS -m a
...
#' **Date:**  `06-20-2017`
#' 
#' **Input File Directory:**  `/mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/6_miRNA_eQT_target_prediction`
#' 
#' **Input File(s):** 
#' 
...
#' 
#' ## Load data
cd /mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/6_miRNA_eQT_target_prediction
...
# --2017-06-19 17:08:16--  http://www.targetscan.org/vert_71/vert_71_data_download/miR_Family_Info.txt.zip
...
# 100%[====================================================================================================================>] 178,768     --.-K/s   in 0.1s

# 2017-06-19 17:08:18 (1.35 MB/s) - “miR_Family_Info.txt.zip” saved [178768/178768]
...
# --2017-06-19 17:13:33--  http://www.targetscan.org/vert_71/vert_71_data_download/UTR_Sequences.txt.zip
# Resolving www.targetscan.org... 18.4.1.128
# Connecting to www.targetscan.org|18.4.1.128|:80... connected.
# HTTP request sent, awaiting response... 200 OK
...
# 100%[====================================================================================================================>] 795,617,238 5.26M/s   in 2m 5s

# 2017-06-19 17:15:38 (6.09 MB/s) - “UTR_Sequences.txt.zip” saved [795617238/795617238]
...
#' -------------
cd /mnt/research/pigeqtl/analyses/microRNA/2_mirna_characterization_expression/6_miRNA_eQT_target_prediction/scripts

/mnt/home/perrykai/targetscan_70/targetscan_70.pl ../2_hsa_mirna_targetscan_input.txt ../UTR_sequences_human.txt ../3_targetscan_miRNA_eQTL_output.txt
